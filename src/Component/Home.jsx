                    ...
                    <Row className='py-36'>
                        <Col md={12} className='  flex flex-col justify-center pl-6 sm:pl-20 '>
                            <div className='my-4 text-black'>
                                <h1 className='text-3xl  md:text-2xl lg:text-5xl'><span className='birthstone-regular  text-gray-9 00 text-2xl sm:text-3xl md:text-4xl lg:text-5xl'>hello, </span><span className="satisfy-regular text-gray-700   text-2xl sm:text-3xl md:text-4xl lg:text-5xl" > I’m Ali Asgar Ansari , A Web Developer and... </span></h1>
                            </div>
