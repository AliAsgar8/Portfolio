...
//     return (
//         <>
//             <nav className='fixed top-4 right-5  pr-10 z-50'>
...
//             {
//                 isOpen && (
//                     <div className='fixed inset-0 z-20 flex flex-col justify-center items-center bg-black text-white text-6xl'>

//                         <ul className='flex flex-col gap-7 dancing-script'>
